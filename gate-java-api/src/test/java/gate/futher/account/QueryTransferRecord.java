...
import com.lzt.vtrading.lib.exchange.model.TransferRecordParam;

public class QueryTransferRecord {
	...
	public static void main(String[] args) {
		...
		param.setStartTime(1707987519L);
		param.setEndTime(1709628414L);

		//contract.setContractId();
		
		System.out.println(JSON.toJSONString(gate.queryTransferRecord(contract,param)));
